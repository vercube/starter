...
interface TypedFlatConfig extends Omit<Linter.FlatConfig, "rules"> {
    rules?: RuleOptions;
}
declare function unjsPreset(config?: MainConfig, ...userConfigs: TypedFlatConfig[]): Linter.Config[];

export { type MainConfig, type TypedFlatConfig, unjsPreset as default };
