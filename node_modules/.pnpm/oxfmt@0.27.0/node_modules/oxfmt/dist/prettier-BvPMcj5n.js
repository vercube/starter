...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-BkUom8Ag.js"));
	try {
...
var estreePlugin = createParsersAndPrinters([{
	importPlugin: () => import("./estree-BHX6cYnM.js"),
...
var { parsers, printers } = createParsersAndPrinters([
	{
		importPlugin: () => import("./acorn-B3s22XVH.js"),
		parsers: ["acorn", "espree"]
	},
	{
		importPlugin: () => import("./angular-Demm-HnE.js"),
		parsers: [
			"__ng_action",
			"__ng_binding",
			"__ng_interpolation",
	...
	{
		importPlugin: () => import("./babel-BnYuG5RT.js"),
		parsers: [
			"babel",
			"babel-flow",
			"babel-ts",
	...
	{
		importPlugin: () => import("./flow-DSDrgZjz.js"),
		parsers: ["flow"]
	},
	{
		importPlugin: () => import("./glimmer-CiQ8731-.js"),
		parsers: ["glimmer"],
		printers: ["glimmer"]
	},
	{
		importPlugin: () => import("./graphql-CMJOaAWJ.js"),
		parsers: ["graphql"],
		printers: ["graphql"]
	},
	{
		importPlugin: () => import("./html-CM5VwdIC.js"),
		parsers: [
			"html",
			"angular",
			"vue",
	...
	{
		importPlugin: () => import("./markdown-XDdiHWR8.js"),
		parsers: [
			"markdown",
			"mdx",
			"remark"
	...
	{
		importPlugin: () => import("./meriyah-HN0R1Vrs.js"),
		parsers: ["meriyah"]
	},
	{
		importPlugin: () => import("./postcss-CxtPsweC.js"),
		parsers: [
			"css",
			"less",
			"scss"
	...
	{
		importPlugin: () => import("./typescript-CIlbIYjH.js"),
		parsers: ["typescript"]
	},
	{
		importPlugin: () => import("./yaml-BkUom8Ag.js"),
		parsers: ["yaml"],
		printers: ["yaml"]
	}
]);
